...
const handleFormSumbit = () => {
  ...
  if(!validarTipo(tipoProductos)){
    ...
    tipoProductos.style.borderColor = "red";
  } else {
    tipoProductos.style.borderColor = "";
  }

  if(!validarFotos(fotos)){
    isValid = false;
    errorMessage += "Por favor, ingresa al menos una foto.\n";
  }

  if(!validarRegion_Comuna(region,comuna)){
    isValid = false;
...
document.getElementById('agregarProducto').addEventListener('click', handleFormSubmit);
